# Network Analysis of Disease-Gene Associations
...
Studying disease gene networks is crucial for understanding the shared genetic and molecular pathways underlying comorbidities. This project analyzes network data using various graph theory techniques, including community detection, centrality analysis, and visualization. The analysis is done using Python's NetworkX library.
